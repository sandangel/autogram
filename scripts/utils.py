...
# The old sentencepiece model depends on old protobuf version
# So we use the new sentencepiece model from transformers.
import transformers.utils.sentencepiece_model_pb2_new as model
